export const en = {
  login: {
    ...
    generalErr: "Login failed, please try again",
    successLogout: "You succesfully logged out.",
  },
  register: {
    title: "Register",
    email: "E-mail",
    ...
    existing: "User with that email address already exists, log in instead!",
  },
  resetPwd: {
    submit: "Set new password",
    title: "Reset password",
    success:
      "Password was reset succesfully, you can now log in using the new password.",
  ...
  forgot: {
    ...
    success: "If the account exists, we have sent instructions to your email.",
  ...
  services: {
    title: "Our services",
    subtitle1: "Why have your own real estate agency in Tenerife",
    p1: "We have been living and working in Tenerife for",
    b1: " more than 8 years.",
    p2: "We know the local market, legislation, mentality, and how life really works on the island. Thanks to this, we can help you",
    b2: "save time, money, and stress,",
    p3: "and guide You safely through the entire process of buying property in Spain.",
    p4: "We are not a remote broker.",
    b4: "We are your local support in Tenerife.",
    subtitle2: "We represent your interests exclusively",
    p5: "Our goal is not a quick sale, but",
    b5: "the right decision for you.",
    list1: [
      "We defend the interests of the buyer",
      "We communicate fluently in Czech, Slovak, and Spanish",
      "We monitor every step of the process",
      "We keep our word and see things through to the end",
    ],
    p6: "In an environment we know perfectly well, we are always on your side.",
    subtitle3: "Complete turnkey real estate service",
    p7: "We will take care of the entire process of buying a property in Tenerife for you:",
    list2: [
      "selection of a suitable property according to your requirements",
      "personal and online viewings",
      "detailed inspection of the property beyond the scope of the advertisement",
      "price negotiation",
      "legal services and cooperation with a certified lawyer",
      "secure transfer of ownership",
    ],
    p8: "The entire process is",
    b8: "transparent, safe, and stress-free for you.",
    subtitle4: "Detailed property inspection (what you don't normally see)",
    p9: "We thoroughly inspect each property, for example:",
    list3: [
      "noise, dust, and surroundings",
      "real technical condition",
      "legal and financial debt-free status",
      "community rules and fees",
      "availability of parking, services, and transportation",
      "price adequacy in the given location and time",
      "approximate estimate of profitability and liquidity",
    ],
    p10: "You will obtain information that you will",
    b10: "not find in the advertisement.",
    subtitle5: "Legal certainty and financial security",
    p11: "We collaborate with knowledgeable lawyers, who:",
    list4: [
      "prepare reservation agreements and power of attorney",
      "represent you during the purchase",
      "ensure legal escrow services",
    ],
    p12: "All financial funds are securely held and released to the seller upon signing the purchase contract.",
    b12: "Our cooperation does not end with the purchase.",
    subtitle6: "Management and long-term rentals",
    p13: "Short-term tourist rentals (VV) are no longer possible in most locations.",
    p14: "That is why we focus on:",
    l5_item1_normal: "finding ",
    l5_item1_bold: "long-term tenants",
    list5: [
      "management of the property during your absence",
      "monitoring of the condition, maintenance, and communication with the community",
    ],
    b14: "Your property is in good hands, even when you are not on the island.",
    subtitle7: "Assistance during your stay in Tenerife",
    p15: "If you arrive in person:",
    list6: [
      "we will help you find accommodation",
      "we will recommend a car rental company or transfers",
      "we will assist you throughout your stay",
      "we will translate meetings and negotiations",
    ],
    p16: "We recommend a minimum stay of",
    b16: "7 days",
    p17: "to ensure that everything runs smoothly.",
    p18: "High-quality properties are only available on the market for a short time. In order to show you only those that are currently available, we will prepare a tailor-made selection for you",
    b18: "10 days before your arrival.",
    subtitle8: "How much does it cost to buy a property?",
    p19: "Approximately",
    b19: "11 %",
    p20: "must be added to the price of the property, which includes:",
    list7: ["taxes", "notary and legal fees", "commission and other costs"],
    p21: "We will always",
    b21: "explain everything to you transparently in advance.",
    p22: "Regarding financing, we are happy to help you navigate the options. If you are considering a loan",
    b22: "an American mortgage.",
    p23: "is a particularly good option. It is the ideal choice if you already own another property in the Czech Republic that you can use as collateral. This will give you cash that you can use as you wish for a purchase abroad.",
    b23: "Mortgage without borders (ČSOB):",
    p24: "We have had good experiences with this product, which is designed specifically for the purchase of real estate in certain foreign destinations. You can handle the entire process with your bank in Czechia.",
    p25: "The easiest way for Slovak clients remains",
    b25: "to pledge real estate in Slovakia",
    p26: "and draw on a non-purpose loan, a so-called American mortgage. The advantage is that the bank does not examine the purpose of the funds, so you can use them to finance the purchase of real estate in Spain as you wish.",
    subtitle9: "And something extra...",
    p27: "After a successful purchase, we will be happy to invite you to an",
    b27: "authentic Canarian dinner,",
    p28: "where you will experience the true atmosphere of Tenerife.",
    p29: "Because for us, cooperation is also about relationships, not just contracts 😊",
    subtitle10: "Do you feel like it's too much?",
    p30: "That's what we're here for.",
    p31: "We will take care of the authorities, legal steps, translations, organizing meetings, and the entire process so that you can look forward to",
    b31: "your new home in Tenerife",
    p32: "– without unnecessary worries.",
    p33: "If you have any further questions, we recommend that you take a look at the",
    link: "FAQ",
    p34: "section, where we address the most common topics.",
  ...
  usrSettings: {
    ...
    phoneInv: "Invalid phone number",
    currPwd: "Enter your current password",
    validPwd: "Password must be at least 8 characters long",
    diffPwd: "Passwords do not match",
    loadErr: "Failed to load profile",
    savedUsr: "Profile saved",
    saveErr: "Failed to save profile",
    samePwd: "New password must be different from the old one",
    incorrectPwd: "Current password is incorrect",
    changedPwd: "Password has been changed",
    changedErr: "Error changing password",
    title: "Account Settings",
    subtitle: "Profile",
    numFav: "Amount of favorited listings:",
    numForm: "Amount of sent forms:",
    edit: "Edit profile",
    save: "Save",
    cancel: "Cancel",
    change: "Change password",
    changeTit: "Change password",
